import {
  ...
  CalendarCheck, GraduationCap, Wallet, Users, Sparkles, FileText, Smartphone
} from "lucide-react";
      ...
      <SidebarContent>
        ...
        <SidebarGroup>
          ...
          <SidebarMenu>
            ...
            <SidebarMenuItem><SidebarMenuButton asChild><NavLink to="/instalar"><Smartphone className="h-4 w-4 text-primary" />{!collapsed && <span>Instalar App</span>}</NavLink></SidebarMenuButton></SidebarMenuItem>
          </SidebarMenu>
        </SidebarGroup>
      </SidebarContent>
